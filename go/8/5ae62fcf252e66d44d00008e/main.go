/*
	...
	(Source: https://www.codewars.com/kata/5ae62fcf252e66d44d00008e/train/go )
*/
...
func ExpressionMatter(a int, b int, c int) int {
	mathResults := []int{a + b + c, a * b * c, (a + b) * c, a * (b + c)}
	sort.Ints(mathResults)
	return mathResults[3]
}

func main() {
	fmt.Println(ExpressionMatter(1, 2, 3))
	fmt.Println(ExpressionMatter(1, 1, 1))
	fmt.Println(ExpressionMatter(9, 1, 1))
